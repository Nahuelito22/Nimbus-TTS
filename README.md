...
- [ ] Fase 1: Implementación del motor de audio (TTS) y reproducción sin bloqueos.
- [ ] Fase 2: Construcción de la interfaz gráfica (UI).
- [ ] Fase 3: Integración de atajos de teclado globales.
